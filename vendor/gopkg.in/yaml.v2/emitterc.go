...
// put_break a line break to the output buffer.
...
// write_all a whole string into buffer.
...
// yaml_emitter_set_emitter_error an emitter error and return false.
...
// yaml_emitter_need_more_events Check if we need to accumulate more events before emitting.
//
// We accumulate extra
...
// yaml_emitter_append_tag_directive a directive to the directives stack.
...
// yaml_emitter_increase_indent the indentation level.
...
// yaml_emitter_state_machine dispatcher.
...
// yaml_emitter_emit_document_start Expect DOCUMENT-START or STREAM-END.
...
// yaml_emitter_check_empty_document if the document content is an empty scalar.
func yaml_emitter_check_empty_document(emitter *yaml_emitter_t) bool {
	return false // [Go] Huh?
}

// yaml_emitter_check_empty_sequence if the next events represent an empty sequence.
...
// yaml_emitter_check_empty_mapping if the next events represent an empty mapping.
...
// yaml_emitter_check_simple_key if the next node can be expressed as a simple key.
...
// yaml_emitter_select_scalar_style Determine an acceptable scalar style.
...
// yaml_emitter_analyze_version_directive Check if a %YAML directive is valid.
...
// yaml_emitter_analyze_event Check if the event data is valid.
...
// yaml_emitter_write_bom the BOM character.
